...
- Grounded geometric TAMP beats the proposed method on the hardest split.
- Predicate-refinement and cost-model ablations undermine the proposed mechanism.
- False refinement alarms are excessive on low-risk temporal/nuisance cases.
- Abstraction-failure accuracy does not translate into decisive closed-loop success.
